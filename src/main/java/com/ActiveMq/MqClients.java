...
public class MqClients {
     private Log log = LogFactory.getLog(MqClients.class);
   ...
   public static void main(String[] args) {
    ...
    //   connectionFactory = new ActiveMQConnectionFactory("admin", "admin", "tcp://192.168.3.9:61616");
//        try {
...
//            //优先级不能影响先进先出。。。那这个用处究竟是什么呢呢呢呢
           ...
           bean.setId(13);
           String quen="QUEUE_TEST_";
           for(int i=0;i<10;i++){
               senMq senMq=   new senMq(quen+i,i);
