 ...
 public class MqClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            destination=  session.createQueue("mystyle-quend");
           // Destination destination1= session.createTopic("topictest111");
          ...
          //  producer.setDeliveryMode(DeliveryMode.NON_PERSISTENT);
            ...
            producer.send(session.createTextMessage("zhouguotesttesttesttesttestetste"));
          //  producer1.send(session.createTextMessage("zhouguotesttesttesttesttestetste"));
            session.close();
            producer.close();
          //  producer1.close();
            connection.close();
